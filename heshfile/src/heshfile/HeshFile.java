...
public class HeshFile {
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
        ...
        for(int i=0;i<1500;i++)
        {
            ...
            /**
             * такий варіант формування строки набагато кращий! Почитай https://docs.oracle.com/javase/7/docs/api/java/util/Formatter.html
             *
             * Твій код
             *  String rez = "\n"+i+";"+newFile.length()+";"
             ...
             */
            String rez = String.format("\n%d;%d;%s;%d;%s;%d;",i,newFile.length(), md5.getHash(newFile),
                    calculationTime1, sha1.getHash(newFile), calculationTime2);
